...
import com.translink.vehicle.config.InternalSecurityFilter;
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
	    http
	        ...
	        .authorizeHttpRequests(auth -> auth
	            .requestMatchers("/vehicles/**").authenticated()   // Allows Vehicle endpoints
	            .requestMatchers("/maintenance/**").authenticated() // ADD THIS: Allows Maintenance endpoints
	            .requestMatchers("/hubs/**").authenticated()
